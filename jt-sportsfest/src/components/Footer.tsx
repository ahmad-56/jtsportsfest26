        ...
        <div className="grid gap-14 border-b border-white/10 pb-16 md:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_1fr]">
          ...
          <div>
            <Link
              ...
              aria-label="JT SportsFest homepage"
            >
              <Image
            ...
            <Link
              href="/register"
              className="mt-8 inline-flex items-center gap-3 bg-[#36e29b] px-6 py-4 text-sm font-black uppercase tracking-wider text-[#020d20] transition duration-300 hover:-translate-y-1 hover:bg-white"
            >
              Register your team
              ...
              <ul className="space-y-4">
                {navigation.map((item) => (
                  <li key={item.href}>
                    <Link
                      href={item.href}
                      className="group inline-flex items-center gap-3 text-sm font-semibold uppercase tracking-wider text-white/60 transition hover:text-white"
                    >
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center border border-white/10 bg-white/5 text-[#36e29b]">
                  <MapPin size={18} />
                </span>
                ...
                <span>
                  ...
                  <span className="mt-1 block max-w-xs text-sm leading-6 text-white/65">
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 text-sm font-semibold text-white/60 transition hover:text-[#36e29b]"
              >
                <FaInstagram size={19} />
