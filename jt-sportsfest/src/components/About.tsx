...
export default function About() {
  return (
    <section
      id="about"
      className="relative scroll-mt-24 overflow-hidden bg-[#020d20] py-14 text-white sm:py-20"
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(0,99,62,0.22),transparent_55%)] sm:bg-[radial-gradient(circle_at_50%_50%,rgba(0,99,62,0.22),transparent_45%)]" />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 px-4 sm:gap-12 sm:px-6 lg:grid-cols-[1.25fr_0.75fr] lg:items-center">
        <Reveal>
          <div className="text-left">
            ...
            <div className="mt-6 h-1 w-16 rounded-full bg-[#36e29b] sm:mt-8 sm:w-20" />
          </div>
        </Reveal>

        <Reveal>
          <div className="group relative overflow-hidden border border-white/15 bg-[#020d20]/65 p-5 backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:border-[#36e29b]/60 sm:p-7">
            <div className="absolute left-0 top-0 h-full w-1 bg-[#36e29b]" />

            <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#36e29b] sm:text-xs sm:tracking-[0.2em]">
              JT SportsFest XIII
            </p>
            ...
            <div className="mt-5 grid grid-cols-1 gap-3 border-t border-white/10 pt-5 min-[390px]:grid-cols-2 sm:mt-6 sm:gap-4 sm:pt-6">
              <Link
                href="/register"
                className="flex min-h-12 items-center justify-center rounded-lg bg-[#36e29b] px-4 py-3 text-center text-xs font-black uppercase tracking-wider text-[#020d20] shadow-lg shadow-[#36e29b]/10 transition-all duration-300 hover:-translate-y-1 hover:bg-[#48f0aa] hover:shadow-xl hover:shadow-[#36e29b]/30 active:translate-y-0 sm:min-h-14 sm:px-5 sm:py-4 sm:text-sm"
              >
                Register Now
              </Link>
