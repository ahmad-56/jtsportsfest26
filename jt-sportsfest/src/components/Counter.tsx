...
export default function TeamCounter({
  ...
  return (
    <div className="group relative w-full overflow-hidden rounded-xl border border-white/15 bg-[#020d20] px-3 py-2.5 text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-[#36e29b]/60 hover:shadow-[0_18px_40px_rgba(0,99,62,0.30)] lg:w-[240px] lg:px-4 lg:py-3">
      <div className="relative z-10 flex items-center gap-2.5 lg:gap-3">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#00633e] text-[#36e29b] shadow-md shadow-[#00633e]/20 transition-transform duration-300 group-hover:scale-110 lg:h-10 lg:w-10">
          <Users size={14} className="lg:h-4 lg:w-4" />
        </span>

        <div className="min-w-0 flex-1">
          <p className="text-[7px] font-black uppercase tracking-[0.14em] text-[#36e29b] sm:text-[8px]">
