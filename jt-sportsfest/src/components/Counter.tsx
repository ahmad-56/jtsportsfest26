...
export default function TeamCounter({
  ...
  return (
    <div className="group relative w-full overflow-hidden rounded-xl border border-white/15 bg-[#020d20] px-3 py-2.5 text-white shadow-lg lg:w-[240px] lg:px-4 lg:py-3">
      <div className="relative z-10 flex items-center gap-2.5 lg:gap-3">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#00633e] text-[#36e29b] lg:h-10 lg:w-10">
      ...
      <div className="pointer-events-none absolute -bottom-10 -right-10 h-20 w-20 rounded-full bg-[#36e29b]/10 blur-2xl" />
    </div>
  );
}